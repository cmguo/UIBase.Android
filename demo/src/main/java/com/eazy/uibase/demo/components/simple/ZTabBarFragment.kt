...
class ZTabBarFragment : ComponentFragment<TabBarFragmentBinding?, ZTabBarFragment.Model?, ZTabBarFragment.Styles?>(), ZDropDown.DropDownListener {
    ...
    class Styles(private val fragment: ZTabBarFragment) : ViewStyles() {
        ...
        companion object {
            // can't share
            fun createLineIndicator(fragment: ZTabBarFragment, styles: Styles): IPagerIndicator {
    ...
    class ItemBinding(context: Context, private val styles: Styles, private val padding: Boolean) : UnitTypeItemBinding<String?>(context, R.layout.tab_title) {
