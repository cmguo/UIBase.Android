...
public class BadgeAnimator extends ValueAnimator {
    ...
    private WeakReference<XHBBadgeView> mWeakBadge;

    public BadgeAnimator(Bitmap badgeBitmap, PointF center, XHBBadgeView badge) {
        ...
        addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                XHBBadgeView badgeView = mWeakBadge.get();
